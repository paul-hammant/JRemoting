...
public class RegistryHelper {
    ...
    public void put(String key, Object binder) {
        try {
            Class registryClass = this.getClass().getClassLoader().loadClass("org.codehaus.jremoting.registry.Registry");
    ...
    public Object get(String key) {
        try {
            Object registry = this.getClass().getClassLoader().loadClass("org.codehaus.jremoting.registry.Registry").newInstance();
            //Binder binder = registry.get("/.codehausRemoting/optimizations/" + uniqueID);
