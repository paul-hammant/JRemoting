...
import org.codehaus.jremoting.tools.javacompiler.JavaCompiler;
...
public class JavacProxyGenerator extends AbstractProxyGenerator {
    ...
    public void generateClass(ClassLoader classLoader) {
        ...
        jc.doCompile(getSrcGenDir() + File.separator + "JRemotingGenerated" + getGenName() + "_Main.java");
    ...
    public void makeSource(ClassLoader classloader, String name, PublicationDescriptionItem[] interfacesToExpose) throws ProxyGenerationException {
        ...
        classSource.print("public final class JRemotingGenerated" + getGenName() + "_" + name);
    ...
    private void generateMethodBody(PrintWriter classSource, Class[] argTypes, Class rClass, String methodSignature, Method method, String proxyMethodName) {
        ...
        classSource.println("        throw new org.codehaus.jremoting.client." + "InvocationException(\"Should never get here: \" +t.getMessage());");
        classSource.println("      }");
        classSource.println("    }");
    }
