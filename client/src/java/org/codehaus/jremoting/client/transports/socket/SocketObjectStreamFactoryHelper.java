...
public class SocketObjectStreamFactoryHelper extends AbstractFactoryHelper {
    ...
    public SocketObjectStreamFactoryHelper(ExecutorService executorService, ClientMonitor clientMonitor, ConnectionPinger connectionPinger) {
    ...
    public InterfaceLookup getInterfaceLookup(String factoryString, ClassLoader interfacesClassLoader) throws ConnectionException {
        ...
        HostContext hc = new SocketObjectStreamHostContext(executorService, clientMonitor, connectionPinger, interfacesClassLoader, terms[1], Integer.parseInt(terms[2]));
